  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 ">
      <div className="max-w-5xl mx-auto px-4 text-center mb-8 sm:mb-12 md:mb-14">
        <h2
          className={`leading-[1.7] lg:leading-none  ${
            i18n.language === "en"
              ? "text-2xl pt-5 sm:pt-0"
              : "text-xl lg:text-[32px]"
          }  sm:text-3xl md:text-4xl lg:text-[38px]  font-semibold mb-2 text-[#23272E] mt-10`}
        >
          {t("supportSection.main_title")}
        </h2>
        <p
          className={`leading-[1.7] lg:leading-none ${
            i18n.language === "en" ? "text-md" : "text-xs"
          }  sm:text-lg md:text-xl text-[#8B8B8B] ${
            i18n.language === "ta" ? "max-w-3xl" : "max-w-xl"
          } mx-auto`}
          style={{
            fontFamily: "Sora",
            fontWeight: 400,
