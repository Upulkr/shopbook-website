          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 my-6 sm:my-8 mx-2 sm:mx-6 md:mx-10 lg:mx-14">
            <Card className="flex-1 min-w-[180px] sm:min-w-[220px] md:min-w-[200px] lg:min-w-[260px] flex flex-col items-center py-4 sm:py-6 px-2 sm:px-4 bg-white border border-[#ECEAE8] shadow-sm rounded-xl mb-4 md:mb-0">
              ...
              <Button
                ...
                size="sm"
              >
                <Phone className="w-4 h-5" /> {t('needMoreHelpSection.call_us_button')} {/* Translated */}
              </Button>
            </Card>
            <Card className="flex-1 min-w-[180px] sm:min-w-[220px] md:min-w-[200px] lg:min-w-[260px] flex flex-col items-center py-4 sm:py-6 px-2 sm:px-4 bg-white border border-[#ECEAE8] shadow-sm rounded-xl mb-4 md:mb-0">
              <span className="font-semibold text-sm sm:text-base text-[#23272E] mb-2">
              ...
              <Button
                ...
                variant="outline"
              >
                <LucideMessageCircleMore className="w-4 h-5" /> {t('needMoreHelpSection.chat_with_us_button')} {/* Translated */}
              </Button>
            </Card>
            <Card className="flex-1 min-w-[180px] sm:min-w-[220px] md:min-w-[200px] lg:min-w-[260px] flex flex-col items-center py-4 sm:py-6 px-2 sm:px-4 bg-white border border-[#ECEAE8] shadow-sm rounded-xl">
              <span className="font-semibold text-sm sm:text-base text-[#23272E] mb-2">
                {t('needMoreHelpSection.whatsapp_community_title')} {/* Translated */}
              </span>
              <Button
                ...
                variant="outline"
              >
                <Users className="w-4 h-5" /> {t('needMoreHelpSection.join_now_button')} {/* Translated */}
              </Button>
            </Card>
          </div>
        </div>
